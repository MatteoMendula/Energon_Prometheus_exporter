...
class EnergonPrometheusExporter():
    ...
    def __init__(self, app_port=9877, polling_interval_seconds=5):
       ...
       # Start up the server to expose the metrics.
        ...
        # static metrics
        self.device_info = Info("energon_device_info", "Device info")       # power metrics
      ...
      #latency metrics
        self.latency = Gauge("energon_latency", ":D")
        self.delta_lat = Gauge("energon_delta_latency", "when the latency is updated")
        # network metrics
    ...
    def run_metrics_loop(self, lat, delta):
